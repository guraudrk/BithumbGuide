package com.bithumbGuide.coco.service
...
import com.bithumbGuide.coco.dataModel.CurrentPrice
...
class PriceForegroundService : Service(){
    ...
    class PriceForegroundService : Service(){
        ...
        //이 job이라는 놈은 코루틴을 통제하기 위한 놈이다.
        //코루틴을 통제하기 위해서는 이놈을 정의하자.
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            when(intent?.action) {
                ...
                "START" -> {
                    ...
                    //이 job을 안넣어주면 종료를 눌러도 백그라운드에서는 종료되지 않고 계속 동작한다.
                    job = CoroutineScope(Dispatchers.Default).launch {


                        //가격이 변동되는 모습을 계속해서 띄우는 것이다.
                        while (true) {
                            Timber.d("START")
